...
@SessionAttributes("loginMember") // 탈퇴 성공 및 로그아웃에 사용 
...
public class MyPageController {
	...
	public String updateInfo(Member inputMember, String[] memberAddress,
		...
		// inputMember : 입력은 memberNickname / memberTel / memberAdddress(가공 필요)
		...
		// 2. inputMember.memberAddress의 값에 따라 변경하기 
		...
		return "redirect:info"; // 내정보 페이지 재요청 
	}
